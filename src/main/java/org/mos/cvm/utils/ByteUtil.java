...
public class ByteUtil {
    ...
    public static final byte[] TRUE_BYTE_ARRAY = new byte[]{1};
    public static final byte[] FAILED_RESULT = new DataWord(new byte[]{0}).getData();
    public static final byte[] TRUE_RESULT = new DataWord(new byte[]{1}).getData();
